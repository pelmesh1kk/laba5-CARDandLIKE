...
List<Flowers> flowersList = [
  Flowers(
      ...
      "Тип продукта Комнатное растение, Тип продукта (локальный),Комнатное растение ,Тип растения Декоративно-лиственное растение, Род растений Хамедорея",
      ''),
  Flowers(
      "Плант микс ",
      ...
      "Тип продукта Декоративно-лиственное растение Тип продукта (локальный) Комнатное растение Тип растения Декоративно-лиственное растение.",
      ''),
  Flowers(
      "Замиокулькас замифолия",
      ...
      "Тип продукта Комнатное растение Тип продукта (локальный) Комнатное растение Тип растения Декоративно-лиственное растение.",
      ''),
  Flowers(
      "Сансевиерия",
      'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1707922019/lmcode/l9da-wTjiEeFGSZ0U7eVcw/89351062_tmp.jpg',
      "498 ₽.",
      "Невероятное растение, напоминающий траву",
      "Тип продукта Комнатное растение Тип продукта (локальный) Комнатное растение.",
      ''),
  Flowers(
      "Бамбук Лакки (спираль)",
      'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1571669941/lmcode/8feg2fM4okaCMYdd9c9p5A/13532911.png',
      "633 ₽",
      "Бамбук Лакки (спираль) среди цветоводов принято называть «Бамбук или Драцена счастья» — это вечнозеленый многолетник кустарник, который не требует к себе много внимания в уходе. Бамбук Лакки отлично переносит сухость воздуха в помещении, не требует постоянного опрыскивания, приносит удачу и гармонизирует пространство.",
      "Тип продукта Комнатное растение Тип продукта (локальный) Комнатное растение Тип растения Декоративно-лиственное растение.",
      ''),
  Flowers(
      "Примула ",
      'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_2.0/c_pad/w_1000/h_1000/v1677583112/lmcode/ej7-cfedbUilnCqaAMd7-w/83248136_01.jpg',
      "2650 ₽",
  ...
  Flowers(
      "Бегония Элатиор",
      'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_2.0/c_pad/w_1000/h_1000/v1673886887/lmcode/qjHBtEPzAEWlHXJ9BS9-RA/86217139_tmp.png',
      "998 ₽",
      "Фикус Эластика Робуста можно назвать самым неприхотливым среди всех растений семейства фикусовых. Создавать свою собственную коллекцию фикусов стоит именно с этого экземпляра. Растение прекрасно впишется в любой интерьер, не отнимая много времени на уход и содержание.",
      "Тип продукта Комнатное растение Тип продукта (локальный) Комнатное растение Тип растения Декоративно-лиственное растение.",
      ''),
  Flowers(
      "Орхидея Фаленопсис промо",
      ...
      ''),
  Flowers(
      "Роза Кордана в кашпо",
      'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_2.0/c_pad/w_1000/h_1000/v1629097196/lmcode/8QupKTFZ7kmPYoQZF91ibg/82895032.png',
      "5649 ₽",
      "Роза Кордана в кашпо — многолетнее растение, которое может выращиваться как комнатное или в открытом грунте. Миниатюрная кустовая роза высотой 30 см продается в пластиковом горшке диаметром 22 см. Растение цветёт круглый год и отличается миниатюрными размерами цветов и листьев.",
      ...
      ''),
  Flowers(
      "Примула Короткостебельная",
      'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_2.0/c_pad/w_1000/h_1000/v1618326015/lmcode/QMdxcyf1iEORCJhMvor3QQ/83597492.png',
      "220 ₽",
  ...
  Flowers(
      ...
      ''),
  Flowers(
      "Коробка с пионовидными розами, диантусами и эвкалиптом",
  ...
  Flowers(
      ...
      ''),
  Flowers(
      "Воздушное облако белоснежных ромашек",
  ...
  Flowers(
      "Нефролепис микс",
      'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1600252047/lmcode/_7-kxK1Fn0WCV4ASTB4rxg/82560382.png',
      "410 ₽",
      "Нефролепис в ассортименте — декоративно-лиственное растение. Папоротник с изящными зелеными листьями. Он хорошо подходит для украшения интерьера и требует полутени и постоянного увлажнения. Листва устойчива к опаданию.",
      "Тип продукта Комнатное растение Тип продукта (локальный) Комнатное растение Тип растения Декоративно-лиственное растение.",
      '')
];
...
List<Fimage> fimageList = [
  ...
  Fimage([
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1707922019/lmcode/l9da-wTjiEeFGSZ0U7eVcw/89351062_tmp.jpg',
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1707922019/lmcode/-Yga5cJRwU2UI8C0xgYNhQ/89351062_tmp_02.jpg',
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1707922019/lmcode/l9da-wTjiEeFGSZ0U7eVcw/89351062_tmp.jpg'
  ]),
  Fimage([
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1571669941/lmcode/8feg2fM4okaCMYdd9c9p5A/13532911.png',
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1555408674/lmcode/lryLM3rbjEW1ZKB32ZN5DQ/13532911_01.png',
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1571669941/lmcode/8feg2fM4okaCMYdd9c9p5A/13532911.png'
  ]),
  Fimage([
  ...
  Fimage([
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1545755402/lmcode/l-j9_b7bwUG6_bxX9fNWHA/13973995.jpg',
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1634470082/lmcode/v-AHrdRDhUmCuYhhSw5PiA/13973995_i.jpg',
  ]),
  Fimage([
  ...
  Fimage([
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1600252047/lmcode/_7-kxK1Fn0WCV4ASTB4rxg/82560382.png',
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1600252047/lmcode/NZbXCT0Gj0CSCTVsu2weHw/82560382_01.png',
    'https://cdn.leroymerlin.ru/lmru/image/upload/f_auto/q_auto/dpr_1.0/c_pad/w_1000/h_1000/v1619435762/lmcode/4lEE0FmInkeEznQzVwKQhw/82560382_i.jpg',
  ]),
];
